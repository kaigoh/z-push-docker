 ...
 */
define('STATE_SQL_ENGINE', ($_ENV['STATE_SQL_ENGINE'] ? $_ENV['STATE_SQL_ENGINE'] : null));
define('STATE_SQL_SERVER', ($_ENV['STATE_SQL_SERVER'] ? $_ENV['STATE_SQL_SERVER'] : null));
define('STATE_SQL_PORT', ($_ENV['STATE_SQL_PORT'] ? $_ENV['STATE_SQL_PORT'] : null));
define('STATE_SQL_DATABASE', ($_ENV['STATE_SQL_DATABASE'] ? $_ENV['STATE_SQL_DATABASE'] : null));
define('STATE_SQL_USER', ($_ENV['STATE_SQL_USER'] ? $_ENV['STATE_SQL_USER'] : null));
define('STATE_SQL_PASSWORD', ($_ENV['STATE_SQL_PASSWORD'] ? $_ENV['STATE_SQL_PASSWORD'] : null));
