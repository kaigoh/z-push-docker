...
RUN apk update && \
	apk add php7 php7-imap php7-fpm php7-posix php7-pdo php7-mbstring php7-iconv php7-openssl php7-memcached php7-soap php7-pcntl php7-sysvshm php7-sysvsem ca-certificates && \
	rm -rf /var/cache/apk/* && \
